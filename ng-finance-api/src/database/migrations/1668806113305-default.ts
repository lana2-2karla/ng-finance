...
export class default1668806113305 implements MigrationInterface {
    name = 'default1668806113305'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "transactions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "value" integer NOT NULL, "created_At" TIMESTAMP NOT NULL DEFAULT now(), "debitedAccountIdId" uuid, "creditedAccountIdId" uuid, CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`);
